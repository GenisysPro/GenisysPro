...
class PlayerActionPacket extends DataPacket {
	...
	const ACTION_DIMENSION_CHANGE_REQUEST = 13, ACTION_SPAWN_OVERWORLD = 13; //sent when dying in different dimension
	const ACTION_DIMENSION_CHANGE_ACK = 14, ACTION_SPAWN_NETHER = 14; //sent when spawning in a different dimension to tell the server we spawned
