...
# UNSTABLE Branch for Minecraft v1.2
...
**Since this branch is UNSTABLE, we DO NOT suggest any production use of this branch!**
...
__GenisysPro is a feature-rich server software for *Minecraft*.__  
...
* Support for Minecraft for Windows 10
...
简介
-------------
__GenisysPro：多功能 Minecraft 服务器软件__  
...
介紹
-------------
__GenisysPro：功能豐富的 Minecraft 伺服器軟體__  
...
__GenisysProは、*Minecraft* 用の豊富な機能を備えたサーバーソフトウェアです。__  
...
* オプションのXbox Live認証
* Minecraftのサポート：Minecraft for Windows 10
* グローバルリソースパック
...
- [x] 拡張されたプラグインの互換性のため、ファイルの場所を `/src/pocketmine/network/mcpe/`に変更
...
__GenisysPro is een toekomst rijke serversoftware voor *Minecraft*.__
...
* Ondersteuning voor Minecraft for Windows 10
* Global resource packs
...
__GenisysPro - многофункциональное серверное программное обеспечение для *Minecraft*.__  
